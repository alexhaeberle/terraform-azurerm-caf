locals {
  ...
  combined_objects_object_replication                             = merge(tomap({ (local.client_config.landingzone_key) = module.storage_object_replication }), try(var.remote_objects.object_replication, {}))
